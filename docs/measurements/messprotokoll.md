# Messprotokoll — Belluna-Adapterrahmen (Challenger X150)

Datum: __________  ·  Messmittel: Messschieber / Zollstock

## A — Karosseriebefestigungsplatte (am Tisch)
...
| Nr. | Maß | Default | Gemessen [mm] |
|-----|-----|---------|----------------|
| B1a | Heki-Rahmen-Außenkante hinten → Dachkante | — | ______ |
| B1b | Heki-Rahmenbreite (Öffnungskante→Rahmenaußenkante, innen gemessen) | — | ______ |
| B2  | Höhe Dachkante über Dachebene (am Heck) | 55 | ______ |
| B3  | Dachstärke am Ausschnitt | 35 | ______ |
| B4  | Belluna-Haubenunterkante am Hecküberstand, geschlossen (über Plattenauflage) | 30 | ______ |

## C — bei Mini-Heki-Demontage (später)

| Nr. | Maß | Soll | Gemessen [mm] |
|-----|-----|------|----------------|
| C1a | Dachausschnitt Länge × Breite | 400 × 400 | ____ / ____ |
| C1b | Eckenradius Ausschnitt | R5 | ______ |
| C2  | Zustand Klebefläche (Notizen) | — | ______________________ |
