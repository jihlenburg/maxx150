...
> **Archiv:** Dieser Implementierungsplan beschreibt den Aufbau vom 12.07.2026
> und enthält bewusst alte Pfade, Produkte und Zwischenstände. Er ist nicht
> normativ. Aktuell gelten `README.md`, `docs/design.md` und `docs/pipeline.md`.
